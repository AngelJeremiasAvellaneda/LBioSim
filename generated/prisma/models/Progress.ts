...
export type ProgressWhereInput = {
  ...
  visitedModules?: Prisma.EnumModuleIdNullableListFilter<"Progress">
  totalTimeMs?: Prisma.IntFilter<"Progress"> | number
...
export type ProgressOrderByWithRelationInput = {
  ...
  visitedModules?: Prisma.SortOrder
...
export type ProgressScalarWhereWithAggregatesInput = {
  ...
  visitedModules?: Prisma.EnumModuleIdNullableListFilter<"Progress">
  totalTimeMs?: Prisma.IntWithAggregatesFilter<"Progress"> | number
  updatedAt?: Prisma.DateTimeWithAggregatesFilter<"Progress"> | Date | string
}

export type ProgressCreateInput = {
  visitedModules?: Prisma.ProgressCreatevisitedModulesInput | $Enums.ModuleId[]
  totalTimeMs?: number
...
export type ProgressUpdateInput = {
  visitedModules?: Prisma.ProgressUpdatevisitedModulesInput | $Enums.ModuleId[]
...
export type EnumModuleIdNullableListFilter<$PrismaModel = never> = {
  equals?: $Enums.ModuleId[] | Prisma.ListEnumModuleIdFieldRefInput<$PrismaModel> | null
  has?: $Enums.ModuleId | Prisma.EnumModuleIdFieldRefInput<$PrismaModel> | null
  hasEvery?: $Enums.ModuleId[] | Prisma.ListEnumModuleIdFieldRefInput<$PrismaModel>
  hasSome?: $Enums.ModuleId[] | Prisma.ListEnumModuleIdFieldRefInput<$PrismaModel>
  isEmpty?: boolean
}
...
export type ProgressCreatevisitedModulesInput = {
  set: $Enums.ModuleId[]
}

export type ProgressUpdatevisitedModulesInput = {
  set?: $Enums.ModuleId[]
...
export type ProgressOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"userId" | "visitedModules" | "totalTimeMs" | "updatedAt", ExtArgs["result"]["progress"]>
...
export interface ProgressDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const progressWithUserIdOnly = await prisma.progress.findMany({ select: { userId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Progresses and only return the `userId`
   * const progressWithUserIdOnly = await prisma.progress.createManyAndReturn({
   *   select: { userId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Progresses and only return the `userId`
   * const progressWithUserIdOnly = await prisma.progress.updateManyAndReturn({
   *   select: { userId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ProgressFieldRefs {
  ...
  readonly visitedModules: Prisma.FieldRef<"Progress", 'ModuleId[]'>
  readonly totalTimeMs: Prisma.FieldRef<"Progress", 'Int'>
